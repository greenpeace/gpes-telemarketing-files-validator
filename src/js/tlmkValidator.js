...
tlmkValidator.legacyStageValues = [
    "Intender",
    "Considerer",
    "Rejected",
    "Pledge",
...
tlmkValidator.CierreGPValues =[
	"Positivo",
	"Positivo Aumenta cuota",
	"Positivo, Mensualiza sin aum",
	"Positivo aum cuota y donación",
	"Positivo hace donación",
	"Baja",
	"Enviamos cupón",
	"Socio Durmiente",
	"Negativo antes argumentario",
	"Negativo",
	"Queria baja pero se mantiene",
	"Pendiente. nos llamará",
	"Quejas",
	"No contacto directo con el socio",
	"Contestador automático",
	"Fallecido",
	"Ilocalizable",
	"Teléfono equivocado",
	"Reduce Cuota evitando baja",
	"Retenido aceptando SALTA",
	"Teléfono erróneo o nulo",
    "Negativo Coronavirus",
    "Negativo alta por la web" 
];
...
tlmkValidator.isValidIban = function(iban) {
    ...
    var newIban = iban.replace(/[\.\s-,_\|#]/g, '').toUpperCase();
    // Lenght
